...
{
    setStyleSheet("QSlider::sub-page:Horizontal { background-color: #EE7C03; }"
                  "QSlider::add-page:Horizontal { background-color: #333333; }"
                  "QSlider::groove:Horizontal { background: transparent; height:4px; }"
                  "QSlider::handle:Horizontal { width:13px; height:13px; border:1px solid #EE7C03; border-radius:7px; background:#EE7C03; margin: -5px 0px -5px 0px; }"
